...
Clean the share directory before deploying the install.  Has no effect for
a `system` install.  This option requires [Alien::Build](https://metacpan.org/pod/Alien::Build) 1.74.
